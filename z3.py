...
class MainWindow(QWidget):
    ...
    def initializeUI(self):
        self.setGeometry(200, 200, 240, 110)
        self.setWindowTitle("Радуга")

        self.label = QLabel(self)
        self.label.move(20, 1)
